...
function Band({
  ...
  return (
    <>
      ...
      {/* frustumCulled off: the band's geometry is rebuilt every frame from a
          physics-driven curve, so THREE's cached bounding sphere is always
          stale — culling against it can incorrectly hide the strap near
          viewport edges. */}
